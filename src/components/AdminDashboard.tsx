        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-lg shadow-white/5 overflow-hidden">
              <img src={graaLogo} alt="CSAA Logo" className="w-full h-full object-contain p-1" />
            </div>
            <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-lg shadow-white/5 overflow-hidden">
              <img src={graLogo} alt="CSA Logo" className="w-full h-full object-contain p-1" />
            </div>
          </div>
          <div>
      ...
      <PrescriptionModal
        ...
        onSuccess={() => {
          ...
          setStatusModal({
            ...
            message: 'The medication details have been successfully recorded for the patient.'
          });
        }}
      />
      <StatusModal
